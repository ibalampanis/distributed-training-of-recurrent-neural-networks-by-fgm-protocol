#ifndef __gm_networks_HH__
#define __gm_networks_HH__
...
namespace gm_protocol {
    ...
    namespace gm_networks {

        using namespace gm_protocol::MlPack_GM_Protocol;
 ...
 */
    ...
    } // end namespace gm_networks

} // gm_protocol

namespace dds {
    template<>
    inline size_t byte_size<gm_protocol::gm_networks::learning_node *>(
            gm_protocol::gm_networks::learning_node *const &) { return 4; }
}
