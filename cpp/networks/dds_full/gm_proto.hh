...
/**
  ...
  */
    struct compressed_state_ref {
        ...
        inline compressed_state_ref(const Vec &_vec, size_t _updates) : vec(_vec), updates(_updates) {}
  ...
  */
    ...
    struct gm_comm_results_t : result_table, dataset_results, comm_results {
        ...
        void fill(StarNetwork *nw) {
            ...
            double tcp_naive_traffic =
                    (tcp_channel::tcp_header_bytes + sizeof(dds::stream_update)) * CTX.stream_count();
