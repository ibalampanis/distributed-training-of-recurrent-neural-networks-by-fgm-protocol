...
% Intro pages
    \input{src/intro/thanks.tex}
    \input{src/intro/abstract.tex}
...
% Main page numbers:  1, 2, 3, ...
    ...
    \input{src/chapters/background.tex}
    \input{src/chapters/implementation.tex}
    \input{src/chapters/results.tex}
...
% Appendices
    \appendix
    \input{src/appendix/appendixA.tex}
    \input{src/appendix/appendixB.tex}
\end{document}